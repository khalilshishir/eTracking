		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Item Brand<small>Enter Item Brand.</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:itemBrandInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${itemBrandInstance?.id}" />
							<g:hiddenField name="version" value="${itemBrandInstance?.version}" />
