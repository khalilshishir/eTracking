		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Project Information <small>Enter Project Information .</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:projectInformationInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${projectInformationInstance?.id}" />
							<g:hiddenField name="version" value="${projectInformationInstance?.version}" />
