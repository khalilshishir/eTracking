		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Customer Information <small>Enter Customer Information .</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:customerInformationInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${customerInformationInstance?.id}" />
							<g:hiddenField name="version" value="${customerInformationInstance?.version}" />
