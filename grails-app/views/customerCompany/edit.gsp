		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Customer Company <small>Enter Customer Company .</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:customerCompanyInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${customerCompanyInstance?.id}" />
							<g:hiddenField name="version" value="${customerCompanyInstance?.version}" />
