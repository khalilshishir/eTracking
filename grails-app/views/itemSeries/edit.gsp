		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Item Series<small>Enter Item Series.</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:itemSeriesInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${itemSeriesInstance?.id}" />
							<g:hiddenField name="version" value="${itemSeriesInstance?.version}" />
