		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Customer Geographical Location <small>Customer Geographical Location .</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:customerGeographicalLocationInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${customerGeographicalLocationInstance?.id}" />
							<g:hiddenField name="version" value="${customerGeographicalLocationInstance?.version}" />
