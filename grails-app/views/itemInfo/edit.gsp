		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Item Info<small>Enter Item Info.</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:itemInfoInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${itemInfoInstance?.id}" />
							<g:hiddenField name="version" value="${itemInfoInstance?.version}" />
