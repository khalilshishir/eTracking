		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Customer Unit <small>Enter Customer Unit .</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:customerUnitInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${customerUnitInstance?.id}" />
							<g:hiddenField name="version" value="${customerUnitInstance?.version}" />
