		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Service Type<small>Enter Service Type.</small></h5>
					...
					<div class="ibox-content">
						...
						<g:form url="[resource:serviceTypeInstance, action:'update']" method="PUT" class="form-horizontal" >

							<g:hiddenField name="id" value="${serviceTypeInstance?.id}" />
							<g:hiddenField name="version" value="${serviceTypeInstance?.version}" />
