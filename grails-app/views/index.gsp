            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins text-center">
                       %{-- <%
                        def allCustomerList=CustomerInformation.list()
                        def allCustomerSize=allCustomerList.size();
                        def customerList=CustomerInformation.findAllWhere(isActive: Boolean.TRUE)
                        def size=customerList.size();
                        %>
                    ${size}--}%
                    4</h1>
        ...
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins text-center">
                  %{--      <%
                            def allItemList=com.org.item.ItemInfo.list()
                            def allItemSize=allItemList.size();
                            def activeItemList=com.org.item.ItemInfo.findAllWhere(itemStatus: Boolean.TRUE)
                            def activeItemSize=activeItemList.size();
                        %>
                    ${activeItemSize}--}%
                        10
                    </h1>
